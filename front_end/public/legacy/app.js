...
// ==========================================
// STOP BUTTON (halts simulation only - unlike
// Reset, doesn't clear serial output/gpio state)
// ==========================================
...
document.getElementById("stopBtn").addEventListener("click",()=>{
    ...
    serial.innerHTML += "<br>⏹ Simulation stopped.<br>";
...
document.getElementById("runBtn").addEventListener("click",()=>{
    ...
    setTimeout(()=>{
        ...
        // If nothing has been built onto the canvas yet, Run should
        // behave like a real "compile & flash": build straight from
        // whatever is in the code editor (this is what makes "paste
        // code -> click Run" work without pressing "Build Circuit"
        // first). If a circuit already exists - e.g. from AI Generate,
        // whose exact button/blink/potentiometer logic can't always
        // be re-derived by just regex-scanning the code text - just
        // re-run it as-is instead of rebuilding over it.

        const hasCircuit =
            document.querySelectorAll(".placed-component").length > 0;

        if(!hasCircuit && typeof buildCircuitFromArduino === "function"){
...
// ==========================================
// (AI Generate + standalone Build buttons removed -
// AI Chat panel handles generation now, and Run
// already calls buildCircuitFromArduino() itself
// when there's no circuit yet - see runBtn above.)
// ==========================================
